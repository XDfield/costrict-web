	...
	stmts := []string{
		`CREATE TABLE capability_items (
			...
			forked_from_item_id TEXT, forked_from_owner_id TEXT, parent_plugin_id TEXT,
				...
				source_git_server_id TEXT NOT NULL DEFAULT '', source_git_repo_id INTEGER NOT NULL DEFAULT 0, source_git_entry_key TEXT NOT NULL DEFAULT '', git_sha TEXT NOT NULL DEFAULT '', git_last_synced_at DATETIME, git_sync_status TEXT NOT NULL DEFAULT '', git_sync_error TEXT NOT NULL DEFAULT '', is_built_in INTEGER DEFAULT 0,
