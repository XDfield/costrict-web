...
// Test-local copies of the well-known public-registry identifiers — the
// production constants moved to services.PublicRegistryID once the migrate
// fake-registry path was removed. Keeping them as test-local strings
// avoids dragging the services package into every assertion.
const (
