...
// UserCredentials records the Gitea PAT minted for a user's personal namespace
...
//
// Schema mirrors team_bot_credentials 1:1, with TeamID replaced by
// UserSubjectID (the JWT subject claim from cs-user).
type UserCredentials struct {
	...
	GiteaUsername  string     `gorm:"type:varchar(191);not null;uniqueIndex:uq_user_credentials_gitea_username,where:revoked_at IS NULL" json:"gitea_username"`
