...
func newIngestTestDB(t *testing.T) *gorm.DB {
	...
	stmts := []string{
		...
		`CREATE TABLE capability_items (
			...
			source TEXT DEFAULT '', source_url TEXT DEFAULT '', forked_from_item_id TEXT, forked_from_owner_id TEXT, parent_plugin_id TEXT, is_built_in INTEGER DEFAULT 0, preview_count INTEGER DEFAULT 0,
