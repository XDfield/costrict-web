...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.GitTrustedOriginsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "internal_handlers.GitTrustedOriginsResponse": {
            "type": "object",
            "properties": {
                "origins": {
                    "type": "array",
        ...
        "internal_handlers.ItemResponse": {
            ...
            "properties": {
                ...
                "gitLifecycleChangedAt": {
                    "description": "该 Reason 所代表的那次转换的观测时间；有 Reason 必有此值",
                    "type": "string"
                },
                "gitLifecycleReason": {
                    "description": "仅 git-backed 且 Git 主张归档时：manifest_removed | default_branch_missing | repository_deleted",
                    "type": "string"
                },
                "gitSyncStatus": {
