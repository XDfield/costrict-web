// Package middleware — request-ctx tenant_id hydration.
//
...
// AuthClaims.TenantID is empty, the middleware falls back to
// tenant.DefaultTenantID. This keeps single-tenant behavior correct without
// forcing every caller to handle the "no tenant signal" case.
//
